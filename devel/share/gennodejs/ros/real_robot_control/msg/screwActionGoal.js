...
class screwActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = screwGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new screwActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = screwGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new screwGoal()
    }
...
module.exports = screwActionGoal;
