...
(cl:defmethod cl:initialize-instance :after ((m <force_pub>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'force_pub)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name real_robot_control-msg:<force_pub> is deprecated: use real_robot_control-msg:force_pub instead.")))
...
(cl:defmethod MX-val ((m <force_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader real_robot_control-msg:MX-val is deprecated.  Use real_robot_control-msg:MX instead.")
  (MX m))

(cl:ensure-generic-function 'MY-val :lambda-list '(m))
(cl:defmethod MY-val ((m <force_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader real_robot_control-msg:MY-val is deprecated.  Use real_robot_control-msg:MY instead.")
  (MY m))

(cl:ensure-generic-function 'MZ-val :lambda-list '(m))
(cl:defmethod MZ-val ((m <force_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader real_robot_control-msg:MZ-val is deprecated.  Use real_robot_control-msg:MZ instead.")
  (MZ m))
