...
(cl:defclass <pose_pub> (roslisp-msg-protocol:ros-message)
  ((X
    :reader X
    :initarg :X
    :type cl:float
...
(cl:defclass pose_pub (<pose_pub>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <pose_pub>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'pose_pub)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name real_robot_control-msg:<pose_pub> is deprecated: use real_robot_control-msg:pose_pub instead.")))

(cl:ensure-generic-function 'X-val :lambda-list '(m))
(cl:defmethod X-val ((m <pose_pub>))
...
(cl:defmethod RX-val ((m <pose_pub>))
...
(cl:defmethod RY-val ((m <pose_pub>))
...
(cl:defmethod RZ-val ((m <pose_pub>))
...
(cl:defmethod FX-val ((m <pose_pub>))
...
(cl:defmethod FY-val ((m <pose_pub>))
...
(cl:defmethod FZ-val ((m <pose_pub>))
...
(cl:defmethod theta-val ((m <pose_pub>))
  ...
  (theta m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <pose_pub>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <pose_pub>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<pose_pub>)))
  "Returns string type for a message object of type '<pose_pub>"
  "real_robot_control/pose_pub")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'pose_pub)))
  "Returns string type for a message object of type 'pose_pub"
  "real_robot_control/pose_pub")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<pose_pub>)))
  "Returns md5sum for a message object of type '<pose_pub>"
  "d20e99fa36280381d3010eacb694aaa0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'pose_pub)))
  "Returns md5sum for a message object of type 'pose_pub"
  "d20e99fa36280381d3010eacb694aaa0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<pose_pub>)))
  "Returns full string definition for message of type '<pose_pub>"
  (cl:format cl:nil "float64 X~%float64 Y~%float64 Z~%float64 RX~%float64 RY~%float64 RZ~%float64 FX~%float64 FY~%float64 FZ ~%float64 theta~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'pose_pub)))
  "Returns full string definition for message of type 'pose_pub"
  (cl:format cl:nil "float64 X~%float64 Y~%float64 Z~%float64 RX~%float64 RY~%float64 RZ~%float64 FX~%float64 FY~%float64 FZ ~%float64 theta~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <pose_pub>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <pose_pub>))
