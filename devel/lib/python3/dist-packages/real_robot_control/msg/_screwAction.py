...
"""autogenerated by genpy from real_robot_control/screwAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import real_robot_control.msg
import std_msgs.msg

class screwAction(genpy.Message):
  _md5sum = "d0d9db6e5cb2b5e9f72d11cd35859bc7"
  _type = "real_robot_control/screwAction"
...
"""
  ...
  _slot_types = ['real_robot_control/screwActionGoal','real_robot_control/screwActionResult','real_robot_control/screwActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(screwAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = real_robot_control.msg.screwActionGoal()
      if self.action_result is None:
        self.action_result = real_robot_control.msg.screwActionResult()
      if self.action_feedback is None:
        self.action_feedback = real_robot_control.msg.screwActionFeedback()
    else:
      self.action_goal = real_robot_control.msg.screwActionGoal()
      self.action_result = real_robot_control.msg.screwActionResult()
      self.action_feedback = real_robot_control.msg.screwActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.screw_status
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.screw_status,) = _get_struct_d().unpack(str[start:end])
      return self
