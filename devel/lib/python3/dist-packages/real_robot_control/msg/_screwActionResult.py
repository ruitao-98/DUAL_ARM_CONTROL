...
"""autogenerated by genpy from real_robot_control/screwActionResult.msg. Do not edit."""
import codecs
import sys
...
class screwActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "real_robot_control/screwActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','real_robot_control/screwResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(screwActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = real_robot_control.msg.screwResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = real_robot_control.msg.screwResult()
